...
functionals = ['','CIS','LSDA','BVP86','B3LYP-D','B3PW91','LC-BLYP','LC-PBEPBE','HSEH1PBE','mPW1PW91','$\omega$B97X','APFD','PBE1PBE','MN15','$\omega$B97XD','BH&HLYP','CAM-B3LYP','BMK','M062X','M06','']

#gas abs
La = [None,5.0703,3.8250,3.7413,4,4.1984,4.7390,4.8256,4.2537,4.2837,4.6176,4.2476,4.2848,4.3964,4.5017,4.5686,4.4862,4.4478,4.4971,4.6833, None]
Lb = [None,5.1038,4.4951,4.3821,4,4.6961,4.9435,5.0218,4.7463,4.7563,4.8241,4.7317,4.7619,4.3967,4.5013,4.5662,4.4850,4.4460,4.4964,4.6755, None]
